...
6. Select the **Assets** tab and click **New asset** -> **Work with data and models Python or R notebooks**.
...
7. Find the following Python scripts in the downloaded git repo [applications](https://github.com/ibm-build-lab/VAD-VAR-Workshop/tree/main/content/labs/Watsonx/WatsonxAI/files/201/applications) folder:
   
    - _demo_wml_api.py_

    Load these scripts into your Python IDE.

8. In your Python IDE install the ibm-watson-machine-learning library. We recommend that you use Python 3.10 environment.
...
9. Run the script _demo_wml_api.py_. The output will be shown in the Python terminal.
