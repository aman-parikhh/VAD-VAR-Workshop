...
You can use the same procedure from our setup section(**100.md**) to setup an environment to work with the labs here. If you are attending a workshop, follow the directions of your instructor to access the environment.
...
![](../images/206/image_page9_1.png)

#### 2. Once the project is created, click Open Prompt Lab.
![](../images/206/image_page9_2.png)

#### 3. The Prompt Lab pages open. It should be in the Structured mode. If not, select the Structured tab. 

![](../images/206/image_page9_3.png)
...
#### 14. The flan-t5-xl-3b model returns with Planning, Development this time. This is not what you want.

>Note that you might get a different answer. When in Sampling mode there are more variabilities in completion. However, you are not likely to get the Warehouse and Packaging combination

#### 15. Next, update Top K to 100 — this lets the model consider more possible outcomes

#### 16. Click Generate

![](../images/206/image_page14_1.png)
...
For now, note the following (you will use this information later): T

okens: 53 input + 2 generated = 55 out of 4096

![](../images/206/image_page15_1.png)
...
![](../images/206/image_page19_2.png)

>**Note:** In this case, there are 130 tokens, much bigger than before. For now, just note this information. You will use this information later in this lab.
...
- Compare tokens used in the previous sections
  - Token count for the first section (base prompt engineering): 53
  - Token count for the second section (with 3-shot prompting): 130
...
![](../images/206/image_page32_2.png)

26.  You have the option to Select or create a space. If you have an existing deployment space you can use it. Otherwise select to Create a new deployment space.

![](../images/206/image_page33_1.png)
...
47.  Clear the previous Input and Output by clicking on the Garbage Can icon.
...
- Compare tokens usage.
  ...
  | Attempt                                       | Tokens                                    |
  | --------------------------------------------- | ----------------------------------------- |
  | Prompt engineering Section                    | 53 input + 2 generated = 55 out of 4096   |
  | 3-shot prompting Section                      | 130 input + 2 generated = 132 out of 4096 |
  | Prompt tuned model Section                    | 53 input + 4 generated = 57 out of 4096   |
  | Prompt tuned model (with no Instruction text) | 24 input + 4 generated = 28 out of 4096   |
...
Click Generate and the completion is Planning(instead of Planning, Marketing).
