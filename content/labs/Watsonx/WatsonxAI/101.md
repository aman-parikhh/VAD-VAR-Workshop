...
![homepage_section-1](./images/101/homepage-sections1.png)
![homepage_section-2](./images/101/homepage-sections2.png)
![homepage_section-3](./images/101/homepage-sections3.png)
...
3. Tuning the foundational model with labeled data.

4. Quick links to recently visited pages.

5. API key can be generated from here.

6. Resource Hub - Foundational models, sample prompts, etc can be found here.

7. Developer Hub - Coding Assistant.

8. Shows a list of projects. For the watsonx.ai free tier, you will see a default project called username's sandbox

9. Deployment space - this is where you can add assets in one place to create, run, and manage deployments.
...
![homepage_promptlab](./images/101/homepage-promptlab.png)
