...
4. Click on your prompt to load that saved asset in Prompt Lab by clicking on **Edit** as shown here:

   ![edit](./images/103/edit.png)
...
1. First, let's generate a prompt history. On the opened `Flan_ul2_prompt_v1`, perform the following steps:
...
2. Save this session by clicking the **Save** button. You will see the following:
...
3. You will see the **Save your work** panel that you saw previously. Again, for the name, include your unique id that was previously used to save the Prompt.
   ...
   - **Name**: `Flan_ul2_prompt_session_v1`
   - **Description**: Prompt session - changing Repetition penalty, Top P and Top K.
   - Select **View in project after saving** checkbox
   - Click **Save**
...
4. On the project Assets tab, you should be able to find the saved prompt session using your uniqueid.
   ...
   Select your unique prompt session asset. You will be taken back to the prompt lab.
