...
7. Select No (should be the default) for installing Db2 (2).
8. On the right-hand side at the bottom, accept the Terms and Conditions, then click **Submit** (3).
...
11. The following page opens up. Click **Join account**.
